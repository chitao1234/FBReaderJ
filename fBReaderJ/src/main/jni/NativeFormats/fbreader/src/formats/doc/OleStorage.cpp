...
bool OleStorage::init(shared_ptr<ZLInputStream> stream, std::size_t streamSize) {
	...
	static const char OLE_SIGN[] = {(const char)0xD0, (const char)0xCF, (const char)0x11, (const char)0xE0, (const char)0xA1, (const char)0xB1, (const char)0x1A, (const char)0xE1, (const char)0};
